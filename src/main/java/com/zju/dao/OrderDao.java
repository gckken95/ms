...
public interface OrderDao {
    ...
    @Insert("insert into order_info(user_id,goods_id,delivery_addr_id," +
            "goods_name,goods_count,goods_price,order_channel,status,create_date) " +
            "values(#{userId},#{goodsId},#{deliveryAddrId},#{goodsName}," +
